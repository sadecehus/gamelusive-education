...
export default function Home() {
  ...
  const games = [
    {
      title: t('games.gameNames.animalDetectives'),
    ...
    {
      title: t('games.gameNames.goodOrBad'),
    ...
    {
      title: t('games.gameNames.shoppingAdventure'),
    ...
    {
      title: t('games.gameNames.sentenceTower'),
    ...
    {
      title: t('games.gameNames.journeyToSchool'),
    ...
    {
      title: t('games.gameNames.emotionExplorer'),
      category: t('games.categories.socialAdaptation'),
      age: "Grades 1-4",
      icon: <Smile className="h-5 w-5" />,
      description: t('games.gameDescriptions.emotionExplorer'),
      skills: [t('games.skills.emotionalAwareness'), t('games.skills.socialAwareness'), t('games.skills.criticalThinking')],
      imgSrc: "emotion-explorer.png",
      gamesrc: "games/emotion-explorer",
    },
    {
      title: t('games.gameNames.soundMatch'),
      category: t('games.categories.socialAdaptation'),
      age: "Grades 1-4",
      icon: <Music className="h-5 w-5" />,
      description: t('games.gameDescriptions.soundMatch'),
      skills: [t('games.skills.auditoryDiscrimination'), t('games.skills.socialAwareness'), t('games.skills.criticalThinking')],
      imgSrc: "sound-match.png",
      gamesrc: "games/sound-match",
    },
      {
      title: t('games.gameNames.dailyRoutinesPuzzle'),
      category: t('games.categories.socialAdaptation'),
      age: "Grades 1-5",
      icon: <Puzzle className="h-5 w-5" />,
      description: t('games.gameDescriptions.dailyRoutinesPuzzle'),
      skills: [t('games.skills.auditoryDiscrimination'), t('games.skills.socialAwareness'), t('games.skills.criticalThinking')],
      imgSrc: "daily-routines-puzzle.png",
      gamesrc: "games/daily-routines-puzzle",
    },
      {
      title: t('games.gameNames.trafficSmart'),
      category: t('games.categories.socialAdaptation'),
      age: "Grades 1-4",
      icon: <Car className="h-5 w-5" />,
      description: t('games.gameDescriptions.trafficSmart'),
      skills: [t('games.skills.trafficSafety'), t('games.skills.socialAwareness'), t('games.skills.criticalThinking')],
      imgSrc: "traffic-smart.png",
      gamesrc: "games/traffic-smart",
    },
        {
      title: t('games.gameNames.colorTheVerb'),
      category: t('games.categories.socialAdaptation'),
      age: "Grades 2-6",
      icon: <Car className="h-5 w-5" />,
      description: t('games.gameDescriptions.colorTheVerb'),
      skills: [t('games.skills.grammar'), t('games.skills.vocabulary'), t('games.skills.verbConjugation')],
      imgSrc: "color-the-verb.png",
      gamesrc: "games/color-the-verb",
    },
    {
      title: t('games.gameNames.weatherWizard'),
      category: t('games.categories.weather'),
      age: "Grades 2-6",
      icon: <Sun className="h-5 w-5" />,
      description: t('games.gameDescriptions.weatherWizard'),
      skills: [t('games.skills.weatherAwareness'), t('games.skills.science'), t('games.skills.criticalThinking')],
      imgSrc: "weather-wizard.png",
      gamesrc: "games/weather-wizard",
    },
     {
      title: t('games.gameNames.codeCraft'),
      category: t('games.categories.coding'),
      age: "Grades 3-7",
      icon: <Code className="h-5 w-5" />,
      description: t('games.gameDescriptions.codeCraft'),
      skills: [t('games.skills.coding'), t('games.skills.logic'), t('games.skills.development')],
      imgSrc: "codecraft.png",
      gamesrc: "games/codecraft",
    },
       {
      title: t('games.gameNames.solarSystem'),
      category: t('games.categories.coding'),
      age: "Grades 4-8",
      icon: <Earth className="h-5 w-5" />,
      description: t('games.gameDescriptions.solarSystem'),
      skills: [t('games.skills.planetaryScience'), t('games.skills.astronomy'), t('games.skills.spaceExploration')],
      imgSrc: "solar-system.png",
      gamesrc: "games/solar-system",
    },

       {
      title: t('games.gameNames.ecoGuardian'),
      category: t('games.categories.coding'),
      age: "Grades 3-7",
      icon: <Vegan className="h-5 w-5" />,
      description: t('games.gameDescriptions.ecoGuardian'),
      skills: [t('games.skills.ecology'), t('games.skills.environmentalAwareness'), t('games.skills.sustainability')],
      imgSrc: "eco-guardian.png",
      gamesrc: "games/eco-guardian",
    },
       {
      title: t('games.gameNames.mathRoad'),
      category: t('games.categories.math'),
      age: "Grades 1-8",
      icon: <Plus className="h-5 w-5" />,
      description: t('games.gameDescriptions.mathRoad'),
      skills: [t('games.skills.math'), t('games.skills.geometry'), t('games.skills.problemSolving')],
      imgSrc: "math-road.png",
      gamesrc: "games/math-road",
    },

  ];

  // İlk 6 oyunu göster veya tümünü göster
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <section ref={ref} className="relative h-screen overflow-hidden pt-16 md:pt-0 flex items-center justify-center">
        <motion.div
          style={{ y, opacity }}
      ...
      >
        <div className="container relative z-10 px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
            ...
            <div className="bg-card p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 border border-yellow-100 flex flex-col items-center">
              <div className="relative w-24 h-24 mb-4">
                <Image
                  src="/Litorinos.png"
                  alt="Lithuania Partner"
                  fill
                  className="object-contain"
                />
              </div>
              <h3 className="text-lg font-bold text-center text-slate-900 mb-2">Litorinos</h3>
              <h4 className="text-sm text-slate-600 text-center mb-4">Lithuania</h4>
              <Button 
                variant="outline" 
                size="sm" 
                className="mt-auto"
                onClick={() => window.open('https://www.litorinosmokykla.lt/', '_blank')}
              >
            ...
            <div className="bg-card p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 border border-orange-100 flex flex-col items-center">
              ...
              <h3 className="text-lg font-bold text-center text-slate-900 mb-2">Kocatürk Danışmanlık</h3>
              <h4 className="text-sm text-slate-600 text-center mb-4">Turkey</h4>
              <Button 
                variant="outline" 
                size="sm" 
                className="mt-auto"
                onClick={() => window.open('https://kocaturkdanismanlik.com', '_blank')}
              >
                <ExternalLink className="mr-2 h-3 w-3" /> {t('partners.visitWebsite')}
              </Button>
            </div>
            ...
            <div className="bg-card p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 border border-red-100 flex flex-col items-center">
              ...
              <h3 className="text-lg font-bold text-center text-slate-900 mb-2">Zespół Szkół nr 6 w Rybniku</h3>
              <h4 className="text-sm text-slate-600 text-center mb-4">Poland</h4>
              <Button 
                variant="outline" 
                size="sm" 
                className="mt-auto"
                onClick={() => window.open('https://zs6rybnik.pl/', '_blank')}
              >
                <ExternalLink className="mr-2 h-3 w-3" /> {t('partners.visitWebsite')}
              </Button>
            </div>
            ...
            <div className="bg-card p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 border border-green-100 flex flex-col items-center">
              ...
              <h3 className="text-lg font-bold text-center text-slate-900 mb-2">Global Education Center</h3>
              <h4 className="text-sm text-slate-600 text-center mb-4">Netherlands</h4>
              <Button 
                variant="outline" 
                size="sm" 
                className="mt-auto"
                onClick={() => window.open('https://www.gec.academy/', '_blank')}
              >
                <ExternalLink className="mr-2 h-3 w-3" /> {t('partners.visitWebsite')}
              </Button>
            </div>
            ...
            <div className="bg-card p-8 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 border border-blue-100 flex flex-col items-center">
              ...
              <h3 className="text-lg font-bold text-center text-slate-900 mb-2">IVIAIGO</h3>
              <h4 className="text-sm text-slate-600 text-center mb-4">Lithuania</h4>
              <Button 
                variant="outline" 
                size="sm" 
                className="mt-auto"
                onClick={() => window.open('https://www.ivaigo.lt/', '_blank')}
              >
                <ExternalLink className="mr-2 h-3 w-3" /> {t('partners.visitWebsite')}
              </Button>
            </div>
        ...
        <div className="container relative z-10 px-4">
            ...
            {displayedGames.map((game, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <a
                    href={`/games/${game.gamesrc.split('/').pop()}/index.html`}
                    target="_blank"
          ...
          <div className="text-center mt-12">
            {!showAllGames ? (
              ...
              >
                {t('games.showLess')} <ArrowRight className="ml-2 h-4 w-4 rotate-180" />
              </Button>
            )}
          </div>
        </div>
        ...
        <div className="container px-4">
          ...
          <div className="border-t border-slate-800 mt-8 pt-8 text-center">
            <p className="text-slate-400 mb-2">
              &copy; 2025 Game&apos;Lusive Education. {t('footer.copyright')}
            </p>
